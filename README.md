...
pixi add ldas-tools-ldasgen
# for installing globally
pixi global install ldas-tools-ldasgen
```
...
It is possible to list all of the versions of `ldas-tools-ldasgen` available on your platform:
...
```
pixi search ldas-tools-ldasgen --channel conda-forge
```
